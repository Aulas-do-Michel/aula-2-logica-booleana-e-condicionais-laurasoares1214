...
condicao1 = cromossomo == str("chr17") and posicao >= 41196312 and posicao <= 41277500 and genoma == "hg19"
condicao2 = cromossomo == str("chr17") and posicao >= 43044295 and posicao <= 43125483 and genoma == "hg38"
